...
<div id="page-wrapper">
	...
	<!-- /.row -->
	<form:form id="form-add" action="${baseUrl}/cp/save-a-thesis.html" method="POST" commandName="thesisFormAssign" role="form" accept-charset="UTF-8">
		<div class="row">
		...
		<div class="alert alert-success">
			...
			<div class="col-lg-6">
				<div class="well">
					<h4>Khoa viện</h4>
					<p class="value">${student.masterClass.faculty.faculty_VNName}</p>                    
				</div>
				<div class="well">
					<h4>Tên đề tài</h4>
					<div class='form'>
								...
								<c:forEach items="${professorList}" var="professor">
									<tr class="gradeX">
										 <td><c:out value="${professor.staff_Name}"/></td>
										  <c:if test="${empty professor.department.department_Code}">
										 	<td>Giảng viên ngoài trường</td>
										 	<td>Giảng viên ngoài trường</td>
										 	<td>Giảng viên ngoài trường</td>
										 </c:if>
										  <c:if test="${not empty professor.department.department_Code}">
										 	<td><c:out value="${professor.department.department_Name}"/></td>
										 	<td><c:out value="${professor.department.faculty.faculty_VNName}"/></td>
										 	<td><c:out value="${professor.department.faculty.university.university_VNName}"/></td>
										 </c:if>
										 <td class="center">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#cancel').click(function() {
			window.location = baseUrl + "/cp/listStudentToAssignThesis.html";
		});	
