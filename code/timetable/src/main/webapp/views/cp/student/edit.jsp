...
<div id="page-wrapper">
	...
	<!-- /.row -->
	<form:form id="form-add" action="${baseUrl}/cp/update-a-student.html" method="POST" commandName="studentFormAdd" role="form" accept-charset="UTF-8">
		<div class="row">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#cancel').click(function() {
			window.location = baseUrl + "/cp/students.html";
		});	
