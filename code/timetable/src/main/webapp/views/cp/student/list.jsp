							...
							<tbody>
								<c:forEach items="${studentList}" var="student">
									<tr class="gradeX">
										 ...
										 <td><c:out value="${student.masterClass.faculty.faculty_VNName}"/></td>
										 <td class="center">
...
$(document).ready(function() {
    ...
    $('.add').click(function(){
    	window.location = baseUrl+"/cp/add-a-student.html";
    });
    
});

function v_fViewDetailAStudent(studentId){
	var sViewDetailUrl = baseUrl + "/cp/studentdetail/"+studentId+".html";
...
function v_fRemoveAStudent(studentId){
	...
	if (r == true) {
		var sRemoveAStudentUrl = baseUrl + "/cp/remove-a-student/"+studentId+".html";
