...
<div id="page-wrapper">
	...
	<!-- /.row -->
	<form:form id="form-add" action="${baseUrl}/cp/save-a-professor.html" method="POST" commandName="staffFormAdd" role="form" accept-charset="UTF-8">
		<div class="row">
		...
		<div class="alert alert-success">
			...
			<div class="col-lg-4">
				...
				<div class="form-group">
					<label>Trường</label>
					<div class='form'>
						<form:select path="staffUniversity" class="form-control" name="staffUniversity">
							<option value="HUSTKHMT">Giảng viên trong trường</option>
							<option value="DIFFKHMT">Giảng viên ngoài trường</option>	                       	
	                    </form:select>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#cancel').click(function() {
			window.location = baseUrl + "/cp/professors.html";
		});	
