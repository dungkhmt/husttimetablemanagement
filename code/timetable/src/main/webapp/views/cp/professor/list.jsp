...
$(document).ready(function() {
    ...
    $('.add').click(function(){
    	window.location = baseUrl+"/cp/add-a-professor.html";
    });
    
});

function v_fViewDetailAProfessor(iProfessorId){
	var sViewDetailUrl = baseUrl + "/cp/professordetail/"+iProfessorId+".html";
...
function v_fRemoveAProfessor(iProfessorId){
	...
	if (r == true) {
		var sRemoveAProfessorUrl = baseUrl + "/cp/remove-a-professor/"+iProfessorId+".html";
