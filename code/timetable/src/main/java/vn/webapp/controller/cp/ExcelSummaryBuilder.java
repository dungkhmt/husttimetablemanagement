 ...
 *
 */
public class ExcelSummaryBuilder extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		// get data model which is passed by the Spring container
		List<Topics> listTopics = (List<Topics>) model.get("topicsList");
		List<Patents> listPatents = (List<Patents>) model.get("patentsList");
		...
		Map<String, List<Papers>> summaryAllStaffsList = (Map<String, List<Papers>>) model.get("summaryAllStaffsList");
	 ...
	 * @param workbook
	 */
	public void buildExcelDocumentSummary(Map<String, Object> model, HSSFWorkbook workbook, Map<String, List<Papers>> summaryAllStaffsList){
		...
		for(Map.Entry<String, List<Papers>> summaryStaffs : summaryAllStaffsList.entrySet()) { 
			String staffName = summaryStaffs.getKey();
            List<Papers> listSummaryStaffsPapers = summaryStaffs.getValue();
			...
			if(listSummaryStaffsPapers.size() > 0){
				for(Papers paperSummary : listSummaryStaffsPapers)
				{
